...
void test_matrix_multiply(int M, int N, int K, int ROWS_block_size, int COLS_block_size) 
{
    ...
    printf("Matrix Multiply - Check elapsed time: %f ms\n", elapsed);
...
int main()
{
    ...
    // Test with smaller matrices first for debugging
    printf("Testing 100x100 * 100x100:\n");
    test_matrix_multiply(100, 100, 100, 16, 16);
    
    printf("\nTesting 1000x500 * 500x1000:\n");
    test_matrix_multiply(1000, 1000, 500, 16, 16);
